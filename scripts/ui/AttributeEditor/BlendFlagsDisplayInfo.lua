...
attributeEditor.blendFlagsDisplayInfoSection = function(rollContainer, displayInfo, selection)
  ...
  local rollPanel = rollup:getPanel()
      ...
      rollPanel:beginFlexGridSizer{ cols = 2, rows = 2, flags = "expand" }
        ...
        local trueText = "Optimise"
        local falseText = "Always blend"
        ...
        -- Always Blend Events --------------------------------------------------------------------------
        attributeEditor.log("attributeEditor.addStaticTextWithHelp")
        local blendEventsHelp = getAttributeHelpText(selection[1], "AlwaysCombineSampledEvents")
        ...
        local blendEventsWidget = attributeEditor.addBoolAttributeCombo{
          panel = rollPanel,
          objects = selection,
          attribute = "AlwaysCombineSampledEvents",
